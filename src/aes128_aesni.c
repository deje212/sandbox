...
//public API
void aes128_load_key(char *enc_key)
{
...
void aes128_enc(char *plainText, char *cipherText)
{
...
void aes128_dec(char *cipherText, char *plainText)
{
...
int aes128_self_test(void)
{
  ...
  char enc_key[]    = {0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6, 0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf, 0x4f, 0x3c};
  char cipher[]     = {0x39, 0x25, 0x84, 0x1d, 0x02, 0xdc, 0x09, 0xfb, 0xdc, 0x11, 0x85, 0x97, 0x19, 0x6a, 0x0b, 0x32};
  char computed_cipher[16];
  char computed_plain[16];
  int out = 0;
